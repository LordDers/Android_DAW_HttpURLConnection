...
public class Busqueda extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String nameHolder, lastnameHolder;
    ...
    String finalResult ;
    String HttpURL = "http://allord.pcriot.com/busqueda.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBusqueda.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                ...
                if(CheckEditText){
                    ...
                    UserBusquedaFunction(nameHolder, lastnameHolder, opcionSeleccionada);
                }
                else {
                    // If EditText is empty then this block will execute .
                    Toast.makeText(Busqueda.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void CheckEditTextIsEmptyOrNot(){
        ...
        if(TextUtils.isEmpty(nameHolder) ||  TextUtils.isEmpty(lastnameHolder)) {
            CheckEditText = false;
        } else {
            CheckEditText = true ;
        }
    ...
    public void UserBusquedaFunction(final String nombre, final String apellido, final String asignatura){
        ...
        class UserRegisterFunctionClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = ProgressDialog.show(Busqueda.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if (success == 1) {
                    ...
                    Log.d("No se ha podido buscar", message);
                    //return json.getString(TAG_MESSAGE);
                    Toast.makeText(Busqueda.this,message,Toast.LENGTH_LONG).show();
                }
            }
        ...
        userRegisterFunctionClass.execute(nombre,apellido, asignatura);
    }
}
